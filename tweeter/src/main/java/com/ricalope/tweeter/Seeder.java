...
//        user1.setLikedTweets(new HashSet<Tweet>(user3Tweets));
//        userRepository.saveAndFlush(user1);
//
//        user2.setLikedTweets(new HashSet<Tweet>(user1Tweets));
//        user2.setLikedTweets(new HashSet<Tweet>(user2Tweets));
//        userRepository.saveAndFlush(user2);
//
//        user3.setLikedTweets(new HashSet<Tweet>(user2Tweets));
//        userRepository.saveAndFlush(user3);
//        
//        deletedUser.setLikedTweets(new HashSet<Tweet>(user2Tweets));
//        userRepository.saveAndFlush(deletedUser);
//
//        // ----- List of Following -----
//        Set<User> followingList = Set.of(user2, user3, user4);
//        Set<User> following = Set.of(user1, user5);
//        user3.setFollowing(following);
//        user1.setFollowing(followingList);
//        userRepository.saveAndFlush(user3);
//        userRepository.saveAndFlush(user1);
//        // ----- List of Followers -----
//        Set<User> followersList = Set.of(user3, user5);
